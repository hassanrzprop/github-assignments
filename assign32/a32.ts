...
var current_users:string[]=["ali","hassan","Waqar","zeeshan","wakeel"]
var new_users:string[]=["ali","Noor","wakeel","Haider","Arbaaz"];

function CheckingNames(current_users:string[],new_users:string[]):void{
